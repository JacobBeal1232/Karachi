...
sub graph1
{
  ...
  open ( my $fileh1, ">../bin/QuestionOnePlots/plot1.txt") or die "$!";
  open ( my $fileh2, ">../bin/QuestionOnePlots/plot2.txt") or die "$!";
  open ( my $fileh3, ">../bin/QuestionOnePlots/plot3.txt") or die "$!";
  open ( my $fileh4, ">../bin/QuestionOnePlots/plot4.txt") or die "$!";
  open ( my $fileh5, ">../bin/QuestionOnePlots/plot5.txt") or die "$!";
  open ( my $fileh6, ">../bin/QuestionOnePlots/plot6.txt") or die "$!";
  open ( my $fileh7, ">../bin/QuestionOnePlots/plot7.txt") or die "$!";
  open ( my $fileh8, ">../bin/QuestionOnePlots/plot8.txt") or die "$!";
  open ( my $fileh9, ">../bin/QuestionOnePlots/plot9.txt") or die "$!";
  open ( my $fileh10, ">../bin/QuestionOnePlots/plot10.txt") or die "$!";
  ...
  $R->run(qq`pdf("../bin/QuestionOnePlots/Plots.pdf", width=22,height =17)`);
  # Load the plotting library
  $R->run(q`library(ggplot2)`);
  # read in data from a CSV file
  for my $k (1..10){
    $R->run(qq`data <- read.csv("../bin/QuestionOnePlots/plot$k.txt")`);
